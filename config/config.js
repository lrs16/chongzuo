...
export default {
                  ...
                  routes: [
                    ...
                    },
                    {
                      ...
                      routes: [
                        {
                          path: '/ITSM/home',
                          redirect: '/ITSM/home/eventanalysis',
                        },
                        {
                          ...
                          routes: [
                            {
                              ...
                              name: '出厂测试(临时发布)',
                              icon: 'control',
                              component: './ITSM/Releasemanage/TemporaryRegistration',
                            },
                            {
                              path: '/ITSM/releasemanage/temporary/details',
                              name: '临时发布工单',
                              icon: 'control',
                              component: './ITSM/Releasemanage/TemporaryDetail',
                            },
                            {
                              path: '/ITSM/releasemanage/temporary/list',
                              name: '临时发布工单列表',
                              icon: 'control',
  ...
  proxy: {
    '/auth/': {
      target: ' http://172.16.10.132:9901/', // 登录
      changeOrigin: true,
    },
    '/upms/': {
      target: ' http://172.16.10.132:9901/', // 用户管理
      changeOrigin: true,
    },
    '/auto/': {
      target: ' http://172.16.10.132:9901/', // 软件启停
    ...
    '/basicMonitor/': {
      // 检测管理，基础平台
      target: 'http://172.16.10.132:8889/',
      changeOrigin: true,
    },
    '/activiti/': {
    ...
    '/sys/': {
      target: ' http://172.16.10.132:9901/', // 数据字典
      changeOrigin: true,
    },
    '/check/': {
      target: ' http://172.16.10.132:9901/', // 数据字典
    ...
    '/regist/': {
      target: 'http://172.16.10.132:9901/', // 人员进出管理-人员进出登记
      changeOrigin: true
    },
    '/report/': {
      target: 'http://172.16.10.132:9901/',
    ...
    '/lasting/': {
      target: 'http://172.16.10.132:9901/',        // 自动化运维
      changeOrigin: true
    },
    '/assets/': {
      target: 'http://172.16.10.132:9901/',        // 自动化运维-设备管理、机柜管理
      changeOrigin: true
    },
    '/inspect/': {
      target: 'http://172.16.10.132:9901/',        //  巡检
      changeOrigin: true,
    },
    '/job/': {
      target: 'http://172.16.10.132:9901/',        // 任务调度
      changeOrigin: true
    },
    '/quality/': {
      target: 'http://172.16.10.132:9901/',
    ...
    '/main/': {
      target: 'http://172.16.10.132:9901/',    // 主网集成
      changeOrigin: true
    },
  },
};
