      ...
      <Row gutter={24} type="flex">
        <Col xl={6} xs={12}>
          <Card>
            ...
            {currentHistory.memoryUsage === undefined && <Empty style={{ height: 200 }} />}
            {currentHistory.memoryUsage !== undefined && (
              <div style={{ textAlign: 'center', marginTop: '15px' }}>
                <WaterWave
                  ...
                  title=""
                  color="#66a6ff"
                  percent={numeral(currentHistory.cpuUsage).format('0,0.0')}
                />
              </div>
            )}
          </Card>
        ...
        <Col xl={6} xs={12}>
          <Card>
            ...
            {currentHistory.memoryUsage === undefined && <Empty style={{ height: 200 }} />}
            {currentHistory.memoryUsage !== null && (
              <div style={{ textAlign: 'center', marginTop: '15px' }}>
                <WaterWave
                  height={180}
                  title=""
                  color="#56cfb2"
                  percent={numeral(currentHistory.memoryUsage).format('0,0.0')}
                />
              </div>
            )}
          </Card>
        ...
        <Col span={24}>
          <Card style={{ marginTop: 24 }}>
            ...
            {diskUsage === undefined && <Empty style={{ height: 140 }} />}
            {diskUsage !== undefined && diskUsage.length === 0 && <Empty style={{ height: 140 }} />}
            {diskUsage !== undefined && diskUsage.length > 0 && (
              <BasicBarchart
                height={deviceheight}
