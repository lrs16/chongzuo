          ...
          setTimeout(() => {
            ...
            if (linkdata && linkdata._origin && onGetVal) {
              ...
              handleGetDrawerVal({
                ...linkdata._origin,
                staticName,
                drawtitle: linkdata._origin.type,
              });
            }
          }, 100);
        }}
        ...
        <Interval
          ...
          label={[
            'value',
            {
              type: 'pie',
              content: picdata => {
                return `${picdata.type}：${picdata.value}（ ${(picdata.percent * 100).toFixed(
                  2,
                )}% ）`;
              },
              offset: 20,
