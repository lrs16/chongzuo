          ...
          <Col span={8}>
            <Form.Item label="工作执行结果">
              {getFieldDecorator('execute_result', {
                ...
                <Select placeholder="请选择" allowClear disabled={!showEdit}>
              ...
              {getFieldDecorator('execute_startTime', {
                ...
                <>
                  <DatePicker
                    ...
                    defaultValue={moment(
                      execute.startTime === null ? new Date() : execute.startTime,
                    )}
                    onChange={v => {
                      setFieldsValue({ execute_startTime: moment(v) });
                    }}
                  />
                </>,
              )}
          ...
          <Col span={8}>
            <Form.Item label="实际结束时间">
              {getFieldDecorator('execute_endTime', {
                ...
                initialValue:
                  execute.endTime === null ? moment(new Date()) : moment(execute.endTime),
              })(
                <>
                  <DatePicker
                    showTime
                    ...
                    onChange={v => {
                      setFieldsValue({ execute_endTime: moment(v) });
                    }}
                  />
                </>,
              )}
