  ...
  const searchdata = (values, page, pageSize) => {
    const newvalues = {
      ...
      endTime2: values.endTime?.length
        ...
        : '',
      executeTime: '',
      executeTime1: values.executeTime?.length
        ? moment(values.executeTime[0]).format('YYYY-MM-DD HH:mm:ss')
        : '',
      executeTime2: values.executeTime?.length
        ? moment(values.executeTime[1]).format('YYYY-MM-DD HH:mm:ss')
        : '',
    };
