...
import { Table, Form, Input, Card, Row, Col, Button, DatePicker } from 'antd';
    ...
    <PageHeaderWrapper title={pagetitle}>
      <Card>
        <Row gutter={16}>
          <Form {...formItemLayout}>
            <Col span={8}>
              <Form.Item label="考核编号">{getFieldDecorator('name', {})(<Input />)}</Form.Item>
            </Col>

            <Col span={8}>
              <Form.Item label="考核状态">{getFieldDecorator('name', {})(<Input />)}</Form.Item>
            </Col>
            ...
            <div style={{ display: expand ? 'block' : 'none' }}>
              ...
              <Col span={8}>
                <Form.Item label="发生时间">
                  {getFieldDecorator('name', {})(<RangePicker />)}
                </Form.Item>
              </Col>

              <Col span={8}>
                <Form.Item label="服务商">{getFieldDecorator('name', {})(<Input />)}</Form.Item>
              </Col>
              ...
              <Col span={8}>
                <Form.Item label="责任人">{getFieldDecorator('name', {})(<Input />)}</Form.Item>
              </Col>

              <Col span={8}>
                <Form.Item label="考核类型">{getFieldDecorator('name', {})(<Input />)}</Form.Item>
              </Col>
              ...
              <Col span={8}>
                <Form.Item label="一级指标">{getFieldDecorator('name', {})(<Input />)}</Form.Item>
              </Col>

              <Col span={8}>
                <Form.Item label="二级指标">{getFieldDecorator('name', {})(<Input />)}</Form.Item>
              </Col>

              <Col span={8}>
                <Form.Item label="详细条款">{getFieldDecorator('name', {})(<Input />)}</Form.Item>
              </Col>

              <Col span={8}>
                <Form.Item label="得分">{getFieldDecorator('name', {})(<Input />)}</Form.Item>
              </Col>

              <Col span={8}>
                <Form.Item label="登记人">{getFieldDecorator('name', {})(<Input />)}</Form.Item>
              </Col>
              ...
              <Col span={8}>
                <Form.Item label="是否申诉">{getFieldDecorator('name', {})(<Input />)}</Form.Item>
              </Col>

              <Col span={8}>
                <Form.Item label="申诉内容">{getFieldDecorator('name', {})(<Input />)}</Form.Item>
              </Col>
        ...
        <Table columns={columns} dataSource={tobeDealtarr} />
      </Card>
    </PageHeaderWrapper>
  );
}
