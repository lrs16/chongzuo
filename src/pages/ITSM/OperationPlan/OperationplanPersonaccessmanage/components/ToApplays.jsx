        ...
        <Form {...formItemLayout}>
          ...
          <Col span={8}>
            <Form.Item label="计划进入时间">
              <Input defaultValue={selectedRows.planInTime} disabled />
            </Form.Item>
          </Col>
          <Col span={8}>
          ...
          <Col span={8}>
            <Form.Item label="携带工具">
              <Input defaultValue={selectedRows.carryTool} disabled />
            </Form.Item>
          </Col>
          <Col span={8}>
            <Form.Item label="申请人">
              <Input defaultValue={selectedRows.applyUser} disabled />
            </Form.Item>
          </Col>
          <Col span={8}>
