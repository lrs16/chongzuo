...
import { Chart, Geom, Axis, Tooltip, Label, Legend, View } from 'bizcharts';
...
class Arearangeline extends React.Component {
  render() {
    ...
    const view1Scale = {
      date: {
        type: 'time',
        ticks: ['2020-03-01', '2020-03-08', '2020-03-15', '2020-03-22', '2020-03-29', '2020-04-05'],
      },
      times: {
        min: 0,
        max: 18,
    ...
    const view2Scale = {
      ...
      date: {
        type: 'time',
        ticks: ['2020-01-01', '2020-02-08', '2020-02-15', '2020-03-22', '2020-03-29', '2020-04-05'],
      },
    };
    return (
      <div>
        <Chart padding="auto" forceFit height={height}>
          <Tooltip crosshairs />
          ...
          <View data={markData} scale={view2Scale}>
            ...
            <Geom
              ...
              size={30}
            >
              <Label content="version" custom renderer={formatter} offset={-5} />
            </Geom>
          </View>
